...
memory_agent = Agent(
    ...
    use the update_user_name tools to store it when they introduce themselves.
    ...
    **REMINDER MANAGEMENT GUIDELINES:**
    ...
    4. For viewing:
       - Always use the view_reminders tools when the user asks to see their reminders
